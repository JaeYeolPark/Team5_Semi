			...
			<div class="col-lg-3 me-lg-auto">
				<div class="card border-0 shadow mb-6 mb-lg-0">
					<div class="card-header bg-gray-100 py-4 border-0 text-center">
						<a class="d-inline-block" href="#"><img class="d-block avatar avatar-xxl p-2 mb-2" src="imgPick/profile1.png" alt=""></a>
									...
									<c:if test="${booking.endDate.getTime() > nowTime.getTime()}">
										<div class="col-sm-6 col-lg-4 mb-30px hover-animate" data-marker-id="59c0c8e33b1527bfe2abaf92">
											<div class="card h-100 border-0 shadow">
												<div class="card-img-top overflow-hidden gradient-overlay" style="height: 150px">
												...
												<div class="card-body d-flex align-items-center">
													<div class="w-100">
														<h6 class="card-title">
															<a class="text-decoration-none text-dark" href="detail-rooms.html">${item.title}</a>
														</h6>
														<p class="card-text text-muted">
															<span class="h5 text-primary">68000원</span> / 1박 <br>
															<fmt:formatDate var="startDate" value="${booking.startDate }" pattern="yyyy-MM-dd" />
															<fmt:formatDate var="endDate" value="${booking.endDate }" pattern="yyyy-MM-dd" />
															<span>예약기간</span><br> <span>${startDate }</span> ~ <span>${endDate }</span>
														</p>
													</div>
												</div>
											</div>
