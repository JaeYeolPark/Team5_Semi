				...
				<div class="col-lg-4 mb-5 mb-lg-0">
					...
					<ul class="list-inline">
						<li class="list-inline-item"><a
							class="text-white-50 text-primary-hover" href="#" target="_blank"
				...
				<div class="col-lg-4">
					...
					<form action="#" id="newsletter-form">
						<div class="input-group mb-3">
							<input
								class="form-control bg-transparent border-white-50 border-end-0"
		...
		<div class="container">
			<div class="row align-items-center">
				<div class="col-md-6 text-center text-md-start">
					<p class="text-sm mb-md-0">&copy; 2023, 35place. All rights
						reserved.</p>
				</div>
				<div class="col-md-6">
...
<script src="${path}/resources/vendor/choices/js/choices.min.js"></script>
